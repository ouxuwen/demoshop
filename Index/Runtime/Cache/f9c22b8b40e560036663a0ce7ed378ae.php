		...
		<div class="flexslider">
			<ul class="slides">
				...
				<li style="background: #fa6f57;">
					...
					data-y="60"
					data-speed="600"
					data-start="1200"><div class="vmid"><span>儿童节<br/>清仓</span></div></div>
					...
					<div class="col-md-4">
						<div class="promo accent-background first-child first-row animated" data-animation="fadeInLeft">
							<div class="inner text-center">
								...
								<h5 class="uppercase"> 2017 儿童节 </h5>
							</div>
						</div>
					</div>
						...
						<div class="promo inverse-background first-row animated" data-animation="fadeInDown" style="background: url('__PUBLIC__/index/images/demo/P2200214.jpg') no-repeat; background-size: 100%;">
							<div class="inner text-center np">
								<div class="ribbon">
									...
									<h5 class="text-semibold uppercase nmb"> 精品玩具 </h5>
			...
			<div class="container">
				<div class="row">
					<header class="section-header clearfix col-sm-offset-3 col-sm-6">
						...
						<p class="section-teaser">儿童节狂欢购物盛宴，掌柜强烈推荐最热爆抢款，好评如潮</p>
					</header>
				...
				<div class="row">
					<header class="section-header clearfix col-sm-offset-3 col-sm-6">
						...
						<p class="section-teaser">
							不一样的视觉，不一样的体验，引领玩乐潮流，最新最潮款式尽在本区
						</p>
					</header>
