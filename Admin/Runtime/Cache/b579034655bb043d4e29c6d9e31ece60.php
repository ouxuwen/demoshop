...
<div id="content">
	<!-- 顶部右侧快捷操作按钮 开始 -->
		...
		<div id="breadcrumb">
			...
			<a href="__URL__/lists" title="返回用户管理" class="tip-bottom"> 邮件管理</a>
			<a href="#" class="current"> 编辑邮件模板</a>
		</div>
		<!-- 顶部面包屑导航 结束 -->
		<!-- 主体区域 -->
						...
						<div class="widget-content nopadding">
							...
							<form action="__URL__/edit" method="post" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls"><input type="text" name="description" value="<?php echo ($data["description"]); ?>" /></div>
								</div>
								<div class="control-group">
									<label class="control-label">内容：</label>
									<div class="controls">
										<textarea name="content" id="cona" cols="30" rows="10"><?php echo ($data["content"]); ?></textarea>
									</div>
								</div>
								<!-- 提交提交按钮 -->
