								...
								<div class="control-group">
									...
									<div class="controls">
										<select style="width:80px;" name="year">
											<?php $__FOR_START_5009__=1938;$__FOR_END_5009__=2018;for($i=$__FOR_START_5009__;$i < $__FOR_END_5009__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="month">
											<?php $__FOR_START_13046__=1;$__FOR_END_13046__=12;for($i=$__FOR_START_13046__;$i < $__FOR_END_13046__;$i+=1){ ?><option value="<$i>"><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="day">
											<?php $__FOR_START_22263__=1;$__FOR_END_22263__=31;for($i=$__FOR_START_22263__;$i < $__FOR_END_22263__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
										</select>
									</div>
								</div>
								<div class="control-group">
