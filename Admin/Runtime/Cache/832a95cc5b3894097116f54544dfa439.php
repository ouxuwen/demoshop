								...
								<div class="control-group">
									...
									<div class="controls">
										<select style="width:80px;" name="year">
											<?php $__FOR_START_585__=1938;$__FOR_END_585__=2018;for($i=$__FOR_START_585__;$i < $__FOR_END_585__;$i+=1){ ?><option <?php if($info['birthday'][0] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="month">
											<?php $__FOR_START_26446__=1;$__FOR_END_26446__=12;for($i=$__FOR_START_26446__;$i < $__FOR_END_26446__;$i+=1){ ?><option <?php if($info['birthday'][1] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
										<select style="width:60px;" name="day">
											<?php $__FOR_START_28783__=1;$__FOR_END_28783__=31;for($i=$__FOR_START_28783__;$i < $__FOR_END_28783__;$i+=1){ ?><option <?php if($info['birthday'][2] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
										</select>
									</div>
								</div>
								<div class="control-group">
