...
<!-- 		<div id="style-switcher">
		...
		<div id="content">
			...
			<div id="content-header">
				<h1>控制面板</h1>
				<div class="btn-group">
					<a class="btn btn-large tip-bottom" title="订单管理" href="__APP__/Order/lists"><i class="icon-file"></i></a>
					<a class="btn btn-large tip-bottom" title="用户管理" href="__APP__/User/lists"><i class="icon-user"></i></a>
					<a class="btn btn-large tip-bottom" title="评论管理"  href="__APP__/Comment/lists"><i class="icon-comment"></i><span class="label label-important">5</span></a>
					<a class="btn btn-large tip-bottom" title="购物车管理" href="__APP__/Order/lists"><i class="icon-shopping-cart"></i></a>
				</div>
			</div>
            <!-- 顶部右侧快捷操作按钮 结束 -->
            <!-- 顶部面包屑导航 开始 -->
